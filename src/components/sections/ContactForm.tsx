...
import type { SiteContent } from "@/sanity/getContent";
...
export function Contact({ company, contact }: Props) {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    payload.append("access_key", contact.web3formsAccessKey);
    payload.append("subject", "New enquiry from Veltacorp website");
    payload.append("from_name", "Veltacorp Website");
